...
import com.example.stamped.ui.onboarding.OnboardingActivity
...
class LoginActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!OnboardingActivity.isShown(this)) {
    ...
    private fun setupLanguageToggle() {
        ...
        binding.tvLanguageToggle.setOnClickListener {
            ...
            // Рестартирај ја апликацијата за да се примени новиот јазик
    ...
    private fun setupClickListeners() {
        ...
        binding.btnGoogleLogin.setOnClickListener {
            ...
            // Прво signOut за да присилиме приказ на account chooser
            // (инаку Google SDK автоматски се најавува со последниот корисник)
